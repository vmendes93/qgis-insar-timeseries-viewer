...
PT_TO_EN = {
    ...
    "Relatório da camada": "Layer report",
    "Atualizar relatório": "Refresh report",
    ...
    "Camada: {value}": "Layer: {value}",
    "Pontos: {value}": "Points: {value}",
    "CRS: {value}": "CRS: {value}",
    "Componente: {value}": "Component: {value}",
    "Aquisições: {count} ({start} a {end})": "Acquisitions: {count} ({start} to {end})",
    "Campos temporais: {first} … {last}": "Temporal fields: {first} … {last}",
    "Campo identificador: {value}": "Identifier field: {value}",
    "Campo VEL: {value}": "VEL field: {value}",
    "Campo V_STDEV: {value}": "V_STDEV field: {value}",
    "Campo NoData: {value}": "NoData field: {value}",
    "Avisos: {count}": "Warnings: {count}",
    "Avisos: nenhum": "Warnings: none",
    ...
    "Clicar ponto": "Click point",
    "Clique no mapa para selecionar o ponto InSAR mais próximo": "Click the map to select the nearest InSAR point",
    "Clicando ponto...": "Clicking point...",
    ...
    "Não foi possível reprojetar o clique para a camada de pontos: {error}": "The click could not be reprojected to the point layer: {error}",
    ...
    "Salvar dados CSV...": "Save CSV data...",
    "Exporta as séries temporais atualmente exibidas para CSV": "Exports the currently displayed time-series to CSV",
    "Exportação CSV": "CSV export",
    "Não há dados válidos para exportar.": "There are no valid data to export.",
    "Salvar dados CSV": "Save CSV data",
    "Arquivo CSV (*.csv)": "CSV file (*.csv)",
    "Falha na exportação CSV": "CSV export failed",
    "Não foi possível salvar os dados CSV.\n\n{kind}: {error}": "The CSV data could not be saved.\n\n{kind}: {error}",
    "Dados CSV exportados para {path} ({count} linha(s)).": "CSV data exported to {path} ({count} row(s)).",
    "Exportação CSV concluída": "CSV export complete",
    "Dados salvos em:\n{path}": "Data saved at:\n{path}",
    ...
    "Componente": "Component",
    "Deslocamento cumulativo": "Cumulative displacement",
    "Período": "Period",
    "mm/ano": "mm/yr",
